...
public class ESPoTServerOrchestrator {
	...
	public static void main(String[] args) throws IOException, ParseException {
		...
		Commons.logger.info("ESPoTServerOrchestrator starting up - logging set to info");
		System.out.println("ESPoTServerOrchestrator starting up; printing directly via sysout");
		...
		Commons.logger.info("ESPoTServerOrchestrator started2 - logging set to info");
		System.out.println("ESPoTServerOrchestrator started2 printing directly via sysout");
