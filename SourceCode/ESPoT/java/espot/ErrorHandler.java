...
public class ErrorHandler {
	...
	public static void displayError(Shell inMainShell, Commons inCommons, String inMsg) {
	...
	private static String getCallingMethodName(int inInternalCallCount) {
	...
	public static void showErrorAndQuit(Shell inMainShell, Commons inCommons, String inMsg, Exception inException) {
		int internalCallCount = 0;
		showErrorAndQuit(inMainShell, inCommons, inMsg, inException, internalCallCount);
	}

	public static void showErrorAndQuit(Commons inCommons, String inMsg, Exception inException) {
		int internalCallCount = 0;
		showErrorAndQuit(null, inCommons, inMsg, inException, internalCallCount);
	}

	public static void showErrorAndQuit(Commons inCommons, String inMsg) {
		int internalCallCount = 0;
		showErrorAndQuit(null, inCommons, inMsg, null, internalCallCount);
	}
	
	public static void showErrorAndQuit(Shell inMainShell, Commons inCommons, String inMsg) {
		int internalCallCount = 0;
		showErrorAndQuit(inMainShell, inCommons, inMsg, null, internalCallCount);
	}
		
	public static void messageBoxNumericOnly(Shell inMainShell, Commons inCommons){
		displayError(inMainShell, inCommons, "Enter only numeric");
	}
	
	public static void showErrorAndQuit(Shell inMainShell, Commons inCommons, String inMsg, Exception inException, int inInternalCallCount) {
		inInternalCallCount++;		
	...
	public static boolean confirmationPopup(Display inDisplay, String inMsg) {
	...
	public static void infoPopup(Display inDisplay, String inMsg) {
