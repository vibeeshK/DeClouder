...
public class ClientSideNew_ReviewPojo extends NewReviewPojo{
	...
	public ClientSideNew_ReviewPojo(
			ArtifactKeyPojo inArtifactKeyPojo,String inItemName,String inReviewer,String inCreatedTime,String inProcessStatus,String inReviewFileName,String inReqRespFileName) {
		super(inArtifactKeyPojo,inItemName,inReviewer,inCreatedTime);
	...
	public ClientSideNew_ReviewPojo(
			ArtifactKeyPojo inArtifactKeyPojo,String inItemName,String inReviewer,String inCreatedTime) {
		super(inArtifactKeyPojo,inItemName,inReviewer,inCreatedTime);
	}
