...
public class XtdProjTracker extends ProjTracker implements ExtendedHandler {
	...
	public static final String PROJPLANSH_TaskID_COLHDR = "TaskID (Input; No underscores pl.)";
	public static final String PROJPLANSH_TaskDesc_COLHDR = "Task Desc (Input)";
	public static final String PROJPLANSH_Owner_COLHDR = "Owner (Input; ShortID)";
	public static final String PROJPLANSH_Lead_COLHDR = "Lead (Input; ShortID)";
	public static final String PROJPLANSH_PlannedHours_COLHDR = "PlannedHours (Input)";
	public static final String PROJPLANSH_PlannedStart_COLHDR = "PlannedStart (Input)";
	public static final String PROJPLANSH_PlannedEnd_COLHDR = "PlannedEnd (Input)";
	...
	public static final String RESOURCEPLANSH_ResourceID_COLHDR = "ResourceID (Input; ALL CAPS)";
	public static final String RESOURCEPLANSH_RoleID_COLHDR = "RoleID (Input)";
	public static final String RESOURCEPLANSH_HourlyRate_COLHDR = "Hourly Rate (Input)";
	...
	public static final String IMPEDIMENTSH_Owner_COLHDR = "Owner (ShortID)";
	...
	public static final String DEFECTSH_Owner_COLHDR = "Owner (ShortID)";
