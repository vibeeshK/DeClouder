...
public class ExcelJavaObj {
	...
	public String getKeyAtObjRowNum(int inObjRowNum) {
		return rowObjKeyPointers.get(inObjRowNum);
	}
	...
	public int getShRowNumOfObjRowNum(int inObjRowNum){
	...
	public int getShRowNumForKey(String inRowIDKey){
		...
		return rowObjShIndexes.get(rowObjKeyPointers.indexOf(inRowIDKey));		
	}
	...
	public void setDetailShRowNumForKey(String inRowIDKey, int inShPhysicalRowNum){
		...
		rowObjShIndexes.set(rowObjKeyPointers.indexOf(inRowIDKey),inShPhysicalRowNum);
	}
