...
public class ESPoTClientOrchestrator2 {
	/*
	...
	public static void main(String[] args) throws IOException, ParseException {
		...
		Commons.logger.info("ESPoTClientOrchestrator starting up - logging set to info");
		System.out.println("ESPoTClientOrchestrator starting up; printing directly via sysout");

		OrchestrationData orchestrationData = new OrchestrationData(commons.userName,"ESPoTClientOrchestrator",commons.applicationIcon); 
